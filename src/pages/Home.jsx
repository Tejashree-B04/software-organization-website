            ...
            <div className="row justify-content-evenly">
                ...
                <div className="col-md-3 mt-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <h5 className="card-title">Tejashree</h5>
                ...
                <div className="col-md-3 mt-3">
                    <div className="card">
                        <img src={TeamMember} className="img-fluid" alt="..." />
                        <div className="card-body">
                            <h5 className="card-title">Sanjana</h5>
                            <p className="card-text">Some quick example text to build on the card title and.</p>
                            <a href="#" className="btn btn-primary">More Information</a>
                        </div>
                    </div>
                ...
                <div className="col-md-3 mt-3">
                    <div className="card">
                        <img src={TeamMember} className="img-fluid" alt="..." />
                        <div class="card-body">
                            <h5 className="card-title">Manasa</h5>
                            <p className="card-text">Some quick example text to build on the card title and.</p>
                            <a href="#" className="btn btn-primary">More Information</a>
                        </div>
                    </div>
            ...
            <div className="row justify-content-evenly">
                <div className="col-md-3 mt-4">
                    <div className="card">
                        <img src={TeamMember} className="img-fluid" alt="..." />
                        <div className="card-body">
                            <h5 className="card-title">Rakshita</h5>
                            <p className="card-text">Some quick example text to build on the card title and.</p>
                            <a href="#" className="btn btn-primary">More Information</a>
                        </div>
                    </div>
                ...
                <div className="col-md-3 mt-4">
                    <div className="card">
                        <img src={TeamMember} className="img-fluid" alt="..." />
                        <div className="card-body">
                            <h5 className="card-title">Chandana</h5>
                            <p className="card-text">Some quick example text to build on the card title and.</p>
                            <a href="#" className="btn btn-primary">More Information</a>
                        </div>
                    </div>
                ...
                <div className="col-md-3 mt-4">
                    <div className="card">
                        <img src={TeamMember} className="img-fluid" alt="..." />
                        <div className="card-body">
                            <h5 className="card-title">Jeevan</h5>
                            <p className="card-text">Some quick example text to build on the card title and.</p>
                            <a href="#" className="btn btn-primary">More Information</a>
                        </div>
                    </div>
